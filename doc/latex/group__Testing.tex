...
\begin{DoxyCompactItemize}
\item 
struct \hyperlink{structprogram__arguments}{program\-\_\-arguments} \hyperlink{group__Testing_ga0bc61f89e22f48a0af7de4659a69c6f2}{A\-R\-G\-S}
\item 
\hypertarget{group__Testing_ga35895e417ef253455c9cf365cb66d87c}{void int \hyperlink{group__Testing_ga35895e417ef253455c9cf365cb66d87c}{F\-L\-A\-G\-\_\-\-F\-A\-I\-L\-U\-R\-E}}\label{group__Testing_ga35895e417ef253455c9cf365cb66d87c}

\begin{DoxyCompactList}\small\item\em Flag failure during a test. \end{DoxyCompactList}\end{DoxyCompactItemize}


\subsection{Detailed Description}
A simple but powerful library for writing and executing tests. \subsubsection*{Overview }
...
It is not a very good practice to print large amounts of messages from a test. But, if you really want to print some data, you can use the {\ttfamily M\-S\-G}(...) function. This function works just like {\ttfamily printf}, but prints the information indented, which is neater.
...
\hypertarget{group__Testing_ga28301f76c53b643912da7c538f74e2c6}{\index{Unit Testing Library@{Unit Testing Library}!A\-S\-S\-E\-R\-T@{A\-S\-S\-E\-R\-T}}
\index{A\-S\-S\-E\-R\-T@{A\-S\-S\-E\-R\-T}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{A\-S\-S\-E\-R\-T}]{\setlength{\rightskip}{0pt plus 5cm}\#define A\-S\-S\-E\-R\-T(
\begin{DoxyParamCaption}
\item[{}]{expr}
\end{DoxyParamCaption}
)~{\bf A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G}(expr, \char`\"{}\%s(\%d)\-: A\-S\-S\-E\-R\-T failed\-: \%s \textbackslash{}n\char`\"{},\-\_\-\-\_\-\-F\-I\-L\-E\-\_\-\-\_\-, \-\_\-\-\_\-\-L\-I\-N\-E\-\_\-\-\_\-, \#expr)}}\label{group__Testing_ga28301f76c53b643912da7c538f74e2c6}


Fail the test if an expression is false. 

Much like the lowercase {\ttfamily assert}(...) macro, this macro checks the expression given as argument and fails if it is false. Unlike {\ttfamily assert}, this macro does not abort; execution continues. However, having set \hyperlink{group__Testing_ga35895e417ef253455c9cf365cb66d87c}{F\-L\-A\-G\-\_\-\-F\-A\-I\-L\-U\-R\-E} eventually the test will fail.
...
\hypertarget{group__Testing_ga9be407f8744aff436633d34c62591cb9}{\index{Unit Testing Library@{Unit Testing Library}!A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G@{A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G}}
\index{A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G@{A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G}]{\setlength{\rightskip}{0pt plus 5cm}\#define A\-S\-S\-E\-R\-T\-\_\-\-M\-S\-G(
\begin{DoxyParamCaption}
\item[{}]{expr, }
\item[{}]{format, }
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga9be407f8744aff436633d34c62591cb9}
{\bfseries Value\-:}
\begin{DoxyCode}
...
Like A\-S\-S\-E\-R\-T but with a custom message. 

\begin{DoxySeeAlso}{See Also}
\hyperlink{group__Testing_ga28301f76c53b643912da7c538f74e2c6}{A\-S\-S\-E\-R\-T} 
\end{DoxySeeAlso}


Definition at line 252 of file unit\-\_\-testing.\-h.

\hypertarget{group__Testing_gadeb59351f026036674baa906f32ccd5c}{\index{Unit Testing Library@{Unit Testing Library}!B\-A\-R\-E\-\_\-\-T\-E\-S\-T@{B\-A\-R\-E\-\_\-\-T\-E\-S\-T}}
\index{B\-A\-R\-E\-\_\-\-T\-E\-S\-T@{B\-A\-R\-E\-\_\-\-T\-E\-S\-T}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{B\-A\-R\-E\-\_\-\-T\-E\-S\-T}]{\setlength{\rightskip}{0pt plus 5cm}\#define B\-A\-R\-E\-\_\-\-T\-E\-S\-T(
\begin{DoxyParamCaption}
\item[{}]{tname, }
\item[{}]{descr, }
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{group__Testing_gadeb59351f026036674baa906f32ccd5c}
{\bfseries Value\-:}
\begin{DoxyCode}
...
\hypertarget{group__Testing_gadaaab439c094503b6ed7c313ad082f10}{\index{Unit Testing Library@{Unit Testing Library}!B\-O\-O\-T\-\_\-\-T\-E\-S\-T@{B\-O\-O\-T\-\_\-\-T\-E\-S\-T}}
\index{B\-O\-O\-T\-\_\-\-T\-E\-S\-T@{B\-O\-O\-T\-\_\-\-T\-E\-S\-T}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{B\-O\-O\-T\-\_\-\-T\-E\-S\-T}]{\setlength{\rightskip}{0pt plus 5cm}\#define B\-O\-O\-T\-\_\-\-T\-E\-S\-T(
\begin{DoxyParamCaption}
\item[{}]{tname, }
\item[{}]{descr, }
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{group__Testing_gadaaab439c094503b6ed7c313ad082f10}
{\bfseries Value\-:}
\begin{DoxyCode}
...
\hypertarget{group__Testing_ga3e52396e466caa8cba74e1ae603817d3}{\index{Unit Testing Library@{Unit Testing Library}!T\-E\-S\-T\-\_\-\-S\-U\-I\-T\-E@{T\-E\-S\-T\-\_\-\-S\-U\-I\-T\-E}}
\index{T\-E\-S\-T\-\_\-\-S\-U\-I\-T\-E@{T\-E\-S\-T\-\_\-\-S\-U\-I\-T\-E}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{T\-E\-S\-T\-\_\-\-S\-U\-I\-T\-E}]{\setlength{\rightskip}{0pt plus 5cm}\#define T\-E\-S\-T\-\_\-\-S\-U\-I\-T\-E(
\begin{DoxyParamCaption}
\item[{}]{tname, }
\item[{}]{descr, }
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga3e52396e466caa8cba74e1ae603817d3}
{\bfseries Value\-:}
\begin{DoxyCode}
...
\hypertarget{group__Testing_ga8900225cc98bb7c7fb170b8694e1f7a4}{\index{Unit Testing Library@{Unit Testing Library}!Test@{Test}}
\index{Test@{Test}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{Test}]{\setlength{\rightskip}{0pt plus 5cm}typedef struct {\bf Test}  {\bf Test}}}\label{group__Testing_ga8900225cc98bb7c7fb170b8694e1f7a4}
...
\hypertarget{group__Testing_ga0c4e801b8c3317b802fa4e80e1e26de2}{\index{Unit Testing Library@{Unit Testing Library}!expect@{expect}}
\index{expect@{expect}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{expect}]{\setlength{\rightskip}{0pt plus 5cm}void expect (
\begin{DoxyParamCaption}
\item[{{\bf uint}}]{term, }
\item[{const char $\ast$}]{pattern}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga0c4e801b8c3317b802fa4e80e1e26de2}
...
Subsequent calls to expect add more patterns, that are expected to appear sequentially. \hypertarget{group__Testing_ga2e36933a48fbca44bb782f881ddceb20}{\index{Unit Testing Library@{Unit Testing Library}!M\-S\-G@{M\-S\-G}}
\index{M\-S\-G@{M\-S\-G}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{M\-S\-G}]{\setlength{\rightskip}{0pt plus 5cm}void M\-S\-G (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{format, }
\item[{}]{...}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga2e36933a48fbca44bb782f881ddceb20}


Print formatted messages. 

The messages will be indented to align to the test they belong. \hypertarget{group__Testing_ga4663cf3fb390b2a6d9cf1943f21b9934}{\index{Unit Testing Library@{Unit Testing Library}!register\-\_\-test@{register\-\_\-test}}
\index{register\-\_\-test@{register\-\_\-test}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{register\-\_\-test}]{\setlength{\rightskip}{0pt plus 5cm}int register\-\_\-test (
\begin{DoxyParamCaption}
\item[{const {\bf Test} $\ast$}]{test}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga4663cf3fb390b2a6d9cf1943f21b9934}
...
\end{DoxySeeAlso}
\hypertarget{group__Testing_ga91dbdb97056588b088b689582abc2382}{\index{Unit Testing Library@{Unit Testing Library}!run\-\_\-program@{run\-\_\-program}}
\index{run\-\_\-program@{run\-\_\-program}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{run\-\_\-program}]{\setlength{\rightskip}{0pt plus 5cm}int run\-\_\-program (
\begin{DoxyParamCaption}
\item[{int}]{argc, }
\item[{char $\ast$$\ast$}]{argv, }
\item[{const {\bf Test} $\ast$}]{default\-\_\-test}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga91dbdb97056588b088b689582abc2382}
...
\}
\end{DoxyCode}
 \hypertarget{group__Testing_gac023795199b4f577a9181ac45e62b170}{\index{Unit Testing Library@{Unit Testing Library}!run\-\_\-test@{run\-\_\-test}}
\index{run\-\_\-test@{run\-\_\-test}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{run\-\_\-test}]{\setlength{\rightskip}{0pt plus 5cm}int run\-\_\-test (
\begin{DoxyParamCaption}
\item[{const {\bf Test} $\ast$}]{test}
\end{DoxyParamCaption}
)}}\label{group__Testing_gac023795199b4f577a9181ac45e62b170}


The main routine to run a test. 

This can be called from the main program or even from within tests. \hypertarget{group__Testing_ga0f97d30c4cd1370bcac6d7f4775d6789}{\index{Unit Testing Library@{Unit Testing Library}!sendme@{sendme}}
\index{sendme@{sendme}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{sendme}]{\setlength{\rightskip}{0pt plus 5cm}void sendme (
\begin{DoxyParamCaption}
\item[{{\bf uint}}]{term, }
\item[{const char $\ast$}]{pattern}
\end{DoxyParamCaption}
)}}\label{group__Testing_ga0f97d30c4cd1370bcac6d7f4775d6789}


Ask to receive some bytes from the keyboard. 

This function registers a pattern to be sent from the terminal's keyboard. 

\subsection{Variable Documentation}
\hypertarget{group__Testing_ga0bc61f89e22f48a0af7de4659a69c6f2}{\index{Unit Testing Library@{Unit Testing Library}!A\-R\-G\-S@{A\-R\-G\-S}}
\index{A\-R\-G\-S@{A\-R\-G\-S}!Unit Testing Library@{Unit Testing Library}}
\subsubsection[{A\-R\-G\-S}]{\setlength{\rightskip}{0pt plus 5cm}struct {\bf program\-\_\-arguments}  A\-R\-G\-S}}\label{group__Testing_ga0bc61f89e22f48a0af7de4659a69c6f2}
